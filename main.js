...
const reports = {
  ...
  awards: {
    ...
    blocks: [
      ...
      { type: 'section', index: 'UNIVERSITY', title: copy('Academic excellence and student leadership.', '学业表现与学生领导力。'), text: copy('Outstanding Graduate Student of Southeast University; Outstanding Postgraduate Cadre; multiple First- and Second-Class Academic Scholarships at Chongqing University; Cien Scholarship; innovation and technology awards; Outstanding League Member; and Excellent Youth League Cadre.', '东南大学优秀毕业研究生、优秀研究生干部；重庆大学多次一等与二等奖学金、慈恩奖学金、创新与科技类荣誉、优秀共青团员及优秀团干部。') },
